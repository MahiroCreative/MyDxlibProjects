// FresnelReflectionVS.fx の Direct3D 11 版(vs_4_0。DrawPolygon3DToShader 用)
...
struct VS_INPUT
{
	...
	float4 MirrorProjectionPosition : POSITION1 ;	// 補助座標( spos )
...
VS_OUTPUT main( VS_INPUT VSInput )
{
	...
	// ワールドベクトルをビューベクトルに変換
	VSOutput.ViewNormal.x = dot( lWorldNrm, g_Base.ViewMatrix[ 0 ].xyz ) ;
	VSOutput.ViewNormal.y = dot( lWorldNrm, g_Base.ViewMatrix[ 1 ].xyz ) ;
	VSOutput.ViewNormal.z = dot( lWorldNrm, g_Base.ViewMatrix[ 2 ].xyz ) ;
