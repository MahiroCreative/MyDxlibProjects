// DxLib 公式サンプル「フレネル反射」の Direct3D 11 版。
...
void Mirror_Initialize( void )
{
	...
	FresnelReflectionVS = LoadVertexShader( "shaders/bin/FresnelReflectionVS.vso" ) ;
	FresnelReflectionPS = LoadPixelShader( "shaders/bin/FresnelReflectionPS.pso" ) ;
