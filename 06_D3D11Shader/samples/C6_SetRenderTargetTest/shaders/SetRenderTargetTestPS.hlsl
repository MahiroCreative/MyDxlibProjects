// SetRenderTargetTest のピクセルシェーダー(Direct3D 11 版 / ps_4_0)。2D の描画(DrawPolygon2DToShader)用。
...
// ピクセルシェーダーの出力
// 【D3D11】SV_TARGET の番号が SetRenderTargetToShader の番号(COLOR0 / COLOR1 → SV_TARGET0 / SV_TARGET1)
struct PS_OUTPUT
{
