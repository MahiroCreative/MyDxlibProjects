// SkinMesh4_DirSpotPointLight_ToonVS.fx の Direct3D 11 版(vs_4_0。1〜4 ボーンのスキニングメッシュ)
...
VS_OUTPUT main( VS_INPUT VSInput )
{
	...
	lTotalSpecular += lLightLitDest.z * lLightGen * float4( g_Common.Light[ 1 ].Specular, 0.0f ) ;
	...
	// スペキュラライト合計値 += スペキュラ角度減衰計算結果 * 距離減衰率 * ライトのスペキュラカラー
	lTotalSpecular += lLightLitDest.z * lLightGen * float4( g_Common.Light[ 2 ].Specular, 0.0f ) ;
