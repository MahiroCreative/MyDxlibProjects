// DxLib 関数リファレンス LoadVertexShader のサンプルの Direct3D 11 版。
// Tex1.bmp を貼り付けたポリゴン２枚を頂点シェーダーを使用して左右に動かし、
// ピクセルシェーダーを使用してフェードアウト、フェードインをさせます。
//
// Direct3D 9 版(reference/d3d9_original/C_function/C1_VertexShaderTest)からの変更点には【D3D11】と書いています。
#include "DxLib.h"
