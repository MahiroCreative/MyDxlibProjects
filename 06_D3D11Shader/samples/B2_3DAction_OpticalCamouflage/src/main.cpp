// DxLib 公式サンプル「光学迷彩」の Direct3D 11 版。
...
void CharaCommon_Initialize( void )
{
	...
	Skin4_OpticalCamouflage_VertexShader = LoadVertexShader( "shaders/bin/SkinMesh4_OpticalCamouflageVS.vso" ) ;
	SKin4_OpticalCamouflage_PixelShader = LoadPixelShader( "shaders/bin/SkinMesh4_OpticalCamouflagePS.pso" ) ;
}
