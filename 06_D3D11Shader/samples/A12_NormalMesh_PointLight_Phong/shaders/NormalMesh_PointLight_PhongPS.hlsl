// NormalMesh_PointLight_PhongPS.fx の Direct3D 11 版(ps_4_0)
...
PS_OUTPUT main( PS_INPUT PSInput )
{
	...
	TotalDiffuse += ( float4( g_Common.Light[ 0 ].Diffuse, 0.0f ) * g_Common.Material.Diffuse * DiffuseAngleGen + g_Common.Light[ 0 ].Ambient ) * lLightGen ;
	...
	TotalSpecular += Temp * lLightGen.x * float4( g_Common.Light[ 0 ].Specular, 0.0f ) ;
